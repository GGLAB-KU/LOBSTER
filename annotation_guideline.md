...
## **11\. Understanding the “majority\_decision” and “annotator\_count” Columns**

**majority\_decision**  
 Shows the final label agreed by annotators.

* If it displays **Negative Bias / Positive Bias / No Bias Detected / Unclear**, there is a clear majority.

* **No Majority / Mixed** means annotators disagreed — these items require adjudication.

**annotator\_count**  
 Indicates how many annotators have labeled the fragment.

* Higher numbers \= more reliable agreement.

* Low numbers \= needs more annotations.


Why do some reviews get more than 3 annotations? Because some were complex to decide and we ask for annotators especially at the beginning of annotation. 
