"""
Detect contribution focus of NLP papers from a CSV annotations file.

This script processes a CSV file containing paper metadata (venue, paper_id,
...
Valid v23 labels:
    ...
    LinguisticStudy, DomainAdaptation, SurveyOrPosition, Other
...
DEFAULT_OUTPUT_DIR = PROJECT_ROOT / "dataset" / "evaluation" / "contribution_type"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=DEFAULT_CSV,
        help=f"Input CSV file (default: {DEFAULT_CSV.relative_to(FILE_DIR)})",
    )
    parser.add_argument(
        "--resume",
        type=Path,
...
class PaperProcessor:
    """Handles processing of individual papers from CSV rows."""
    ...
    def process_row(
        ...
        """Process a single CSV row: build prompt, call LLM, save result."""
